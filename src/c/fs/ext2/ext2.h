...
struct disk *create_disk(int, struct partition *);
struct superblock *read_superblock(struct disk *, int);
struct group_descriptor *read_group_descriptor(struct disk *, int);
struct inode *read_inode(struct disk *, int, u32);
char *read_file(struct disk *, struct inode *, u32);
