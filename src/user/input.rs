...
*/
use crate::commands::{blank, hello_world, startfs, clock, shutdown, reset, user, lspci};
...
static commands: [Command; 8] = [
	...
	Command{cmd: ['s', 'h', 'u', 't', 'd', 'o', 'w', 'n', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '], function: shutdown},
	Command{cmd: ['r', 'e', 's', 'e', 't', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '], function: reset},
